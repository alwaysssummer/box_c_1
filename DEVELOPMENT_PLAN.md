...
```
입력: 지문 + 생성된 데이터들 + 문제 유형
      ↓
처리: 역할별 데이터 조합 + 레이아웃 적용
      ↓
출력: 문제 미리보기 → PDF/출력물
```
...
| 태스크 | 우선순위 | 상태 | 설명 |
|--------|---------|------|------|
| - [ ] 2.3.1 문제 조합 로직 | 🟡 | | 역할별 데이터 매핑 |
| - [ ] 2.3.2 문제 미리보기 UI | 🟡 | | 실시간 프리뷰 |
| - [ ] 2.3.3 문제 저장 (선택) | 🟢 | | `generated_questions` 테이블 |
| - [ ] 2.3.4 PDF 생성 | 🟢 | | 문제지/정답지/해설지 |
| - [ ] 2.3.5 일괄 출력 | 🟢 | | 여러 문제 한 번에 출력 |
...
│  소요 시간: ~2시간                                                        │
├─────────────────────────────────────────────────────────────────────────┤
│  Step 3: 문제 생성 구현 (Phase 2.3) ⬅️ 다음 단계                          │
│  ══════════════════════════════════════                                 │
│  • 조합 로직 + 미리보기                                                   │
│  • PDF 출력                                                              │
│  예상 시간: 2-3일                                                         │
